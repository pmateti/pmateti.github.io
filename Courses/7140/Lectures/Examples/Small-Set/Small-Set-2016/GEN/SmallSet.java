/**
 * This class implements a set of integers.  It is limited in size by
 * the sz chosen at compile time.  This is expected to be a good
 * example of software engineering in the tiny.  Possibly contains
 * bugs.  We naively assume all objects are non-null.  It is also
 * intended as an example for use later with learning JUnit/TestNG,
 * JML and FindBugs.
 ...
 * <p> For further details, see ./Design/smallSet-DesignDoc.html

 * <p>Apparently javadoc has no tags for pre- and post-conditions; so
 * I am placing assert()s near the top of the methods for pre- and at
