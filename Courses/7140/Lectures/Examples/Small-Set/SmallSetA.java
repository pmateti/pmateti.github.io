 ...
 * This is expected to be a good example of software design in
 * the tiny^2.  It is also intended as an example for use with
 * learning JUnit/TestNG, JML, PMD, FindBugs, and others.
...
public class SmallSet {
    ...
    public SmallSet(int [] a, int m, int n, int dummy1) {
        assert m < n;
        ear = new int[sz];
        for (int i = m; i < n; i++) {
            insert(a[i]);
