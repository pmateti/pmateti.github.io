...
public class StandaloneGameOfLife extends GameOfLife {
  ...
  class GameOfLifeGridIO {
    ...
    public Shape makeShape( String name, String text ) {
      ...
      Enumeration enm = new LineEnumerator( text );
      while ( enm.hasMoreElements() ) {
        String line = (String) enm.nextElement();
    ...
    public void saveShape() {
      ...
      StringBuffer text = new StringBuffer("!Generator: Game of Life (http://www.bitstorm.org/gameoflife/)"+lineSeparator+"!Variation: 23/3"+lineSeparator+"!"+lineSeparator);
