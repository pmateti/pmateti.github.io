...
org-revealjs() {
    ...
    sed -i $tfnm -e 's@/h1>@/h1><h2 style="color: black"> Prabhaker Mateti</h2><h3>Wright State University</h3><a href="http://cecs.wright.edu/~pmateti">cecs.wright.edu/~pmateti</a><\/section>@'
